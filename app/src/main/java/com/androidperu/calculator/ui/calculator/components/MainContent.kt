...
fun MainContent(
    ...
    val scrollState = rememberScrollState() // Nuevo: Crear rememberScrollState
    ...
    Box(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .horizontalScroll(scrollState) // Nuevo: Agregar horizontalScroll
                .padding(horizontal = 16.dp), // Nuevo: Agregar padding horizontal
